...
// loading Excel File
	...
	{
		FileInputStream fis=new FileInputStream("C:\\Users\\prasanth.s\\workspace\\MavenStockAccounting\\TestInputs\\InputSheet.xlsx");
...
// Writing Data
	...
	FileOutputStream fos=new FileOutputStream("C:\\Users\\prasanth.s\\workspace\\MavenStockAccounting\\TestOutput\\OutputSheet.xlsx");
	wb.write(fos);
	fos.close();
	}
